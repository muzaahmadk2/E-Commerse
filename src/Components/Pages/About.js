      ...
      >
        <p className=" py-4">
          <img
            ...
            alt="img of about"
            className="col-3"
            style={{ display: "block", float: "left", margin: "1em 3em 1em 0", borderRadius:'50%' }}
          />
          ...
          this refused to the pleasures of deleniti? Those are! Will unfold in
          ...
          amet consectetur rebates. The distinction, that arise from or to. The
